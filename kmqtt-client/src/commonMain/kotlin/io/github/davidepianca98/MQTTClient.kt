...
public class MQTTClient(
    ...
    public val willRetain: Boolean = false,
    public val willQos: Qos = Qos.AT_MOST_ONCE,
    public val connackTimeout: Int = 30,
    public val connectTimeout: Int = 30,
    public val autoInit: Boolean = true,
    public val enhancedAuthCallback: (authenticationData: UByteArray?) -> UByteArray? = { null },
    public val onConnected: (connack: MQTTConnack) -> Unit = {},
    public val onDisconnected: (disconnect: MQTTDisconnect?) -> Unit = {},
    public val onSubscribed: (suback: MQTTSuback) -> Unit = {},
    public val onUnsubscribed: (unsuback: MQTTUnsuback) -> Unit = {},
    public val debugLog: Boolean = false,
    public val publishReceived: (publish: MQTTPublish) -> Unit
) {
