...
public class MQTTClient(
    ...
    public var properties: MQTT5Properties = MQTT5Properties(),
    public var willProperties: MQTT5Properties? = null,
    public var willTopic: String? = null,
    public var willPayload: UByteArray? = null,
    public var willRetain: Boolean = false,
    public var willQos: Qos = Qos.AT_MOST_ONCE,
    public var connackTimeout: Int = 30,
    public var connectTimeout: Int = 30,
    public var autoInit: Boolean = true,
    public var enhancedAuthCallback: (authenticationData: UByteArray?) -> UByteArray? = { null },
    public var onConnected: (connack: MQTTConnack) -> Unit = {},
    public var onDisconnected: (disconnect: MQTTDisconnect?) -> Unit = {},
    public var onSubscribed: (suback: MQTTSuback) -> Unit = {},
    public var onUnsubscribed: (unsuback: MQTTUnsuback) -> Unit = {},
    public var debugLog: Boolean = false,
    public var publishReceived: (publish: MQTTPublish) -> Unit
) {
