...
public class MQTTClient(
    ...
    val onConnected: (connack: MQTTConnack) -> Unit = {},
    val onDisconnected: (disconnect: MQTTDisconnect?) -> Unit = {},
    val onSubscribed: (suback: MQTTSuback) -> Unit = {},
    val onUnsubscribed: (unsuback: MQTTUnsuback) -> Unit = {},
    val debugLog: Boolean = false,
    val publishReceived: (publish: MQTTPublish) -> Unit
) {
